...
def main(conf: omegaconf.DictConfig):
    ...
    all_users_data = pd.read_parquet(feature_utils.DATA_ROOT / 'public_train.pqt')
    all_users_data.loc[all_users_data['is_male'] == 'NA', 'is_male'] = 'nan'
    target = conf['target']
